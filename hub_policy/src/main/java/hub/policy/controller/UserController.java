...
import hub.policy.service.CustomerService;
import hub.policy.service.UserService;

@RestController
@RequestMapping("/policy-hub/user")
...
public class UserController {
    ...
    @PostMapping("/forgot-password/{customerId}")
    public ResponseEntity<?> forgetPassword(@PathVariable Long customerId,@RequestBody ForgetPasswordReqDto obj) {
